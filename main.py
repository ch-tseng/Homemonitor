...
lightLED(modeOperation)
#read_Weather()
#speakWords("測試看看!", "MCHEN_Bruce", 15600, 0)
...
try:
	while True:
		...
		if modeOperation==0:
			...
			if t>40:
				...
				if nowHour>7 and nowHour<24:
					if nowMinute==0 and lastHourlySchedule!=nowMinute:
						#靜心語
		...
		if modeOperation==1:
			...
			#特定時間播放TV節目聲音
			if nowMinute==30 and lastHourlySchedule!=nowMinute:
